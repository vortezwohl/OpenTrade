...
该模块集中暴露当前可用 provider 以及它们声明的 provider-specific 扩展命令。 命令装配层不应再把 provider
名称直接暴露为顶层 CLI 根组，而应按扩展命令 自身声明的业务语义路径进行挂载。
"""

from __future__ import annotations

from opentrade.backends.base import BackendProvider
